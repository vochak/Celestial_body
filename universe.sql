...
CREATE TABLE public.moon (
    ...
    geologic_age numeric,
    crater_count integer,
    reflectivity numeric,
    exploration_missions text
);
...
CREATE TABLE public.planet_types (
    ...
    description text,
    example_planet character varying(50),
    composition text,
...
INSERT INTO public.planet_types VALUES (1, 'Terrestrial', 'Rocky planets with a solid surface, like Earth and Mars', NULL, NULL, NULL);
INSERT INTO public.planet_types VALUES (2, 'Gas Giant', 'Large planets with thick atmospheres, like Jupiter and Saturn', NULL, NULL, NULL);
INSERT INTO public.planet_types VALUES (3, 'Ice Giant', 'Planets with icy compositions, like Uranus and Neptune', NULL, NULL, NULL);
INSERT INTO public.planet_types VALUES (4, 'Dwarf Planet', 'Small planetary bodies that are not dominant in their orbits, like Pluto', NULL, NULL, NULL);
INSERT INTO public.planet_types VALUES (5, 'Exoplanet', 'Planets outside our solar system', NULL, NULL, NULL);
...
ALTER TABLE ONLY public.planet_types
    ADD CONSTRAINT planet_types_pkey PRIMARY KEY (id);
